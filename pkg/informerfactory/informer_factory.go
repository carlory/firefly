...
func (i *informerFactory) ForResource(resource schema.GroupVersionResource) (informers.GenericInformer, error) {
	...
	if err != nil {
		informer, err = i.fireflyInformerFactory.ForResource(resource)
		if err != nil {
...
func (i *informerFactory) Start(stopCh <-chan struct{}) {
	...
	i.fireflyInformerFactory.Start(stopCh)
...
func NewInformerFactory(typedInformerFactory informers.SharedInformerFactory, fireflyInformerFactory fireflyinformers.SharedInformerFactory, metadataInformerFactory metadatainformer.SharedInformerFactory) InformerFactory {
	return &informerFactory{
		typedInformerFactory:    typedInformerFactory,
		fireflyInformerFactory:  fireflyInformerFactory,

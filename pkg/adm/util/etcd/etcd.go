...
func GetPeerURLByIP(ip string) string {
	return "https://" + net.JoinHostPort(ip, strconv.Itoa(constants.EtcdListenPeerPort))
}

func GetPeerURLByDomain(domain string) string {
	return "https://" + net.JoinHostPort(domain, strconv.Itoa(constants.EtcdListenPeerPort))
}
...
func GetClientURLByDomain(domain string) string {
	return "https://" + net.JoinHostPort(domain, strconv.Itoa(constants.EtcdListenClientPort))
}

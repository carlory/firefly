...
import (
	...
	constants "github.com/carlory/firefly/pkg/adm/constants"
...
func SubCmdRun() func(c *cobra.Command, args []string) {
	return func(c *cobra.Command, args []string) {
		if len(args) > 0 {
			fireflyadmutil.CheckErr(usageErrorf(c, "invalid subcommand %q", strings.Join(args, " ")))
		}
		c.Help()
		fireflyadmutil.CheckErr(fireflyadmutil.ErrExit)
	}
}
...
func GetKubeConfigPath(file string) string {
	...
	rules.Precedence = append(rules.Precedence, constants.GetAdminKubeConfigPath())

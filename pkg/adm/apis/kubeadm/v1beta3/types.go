...
type InitConfiguration struct {
	...
	// FireflyNamespace is the host cluster's namespace used for objects of the controlplane created by fireflyadm.
	FireflyNamespace string `json:"fireflyNamespace,omitempty"`

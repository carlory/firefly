...
import (
	...
	bootstraptokenv1 "github.com/carlory/firefly/pkg/adm/apis/bootstraptoken/v1"
	"github.com/carlory/firefly/pkg/adm/constants"
)

var (
	// DefaultCertificatesDir defines default certificate directory
	DefaultCertificatesDir = filepath.Join(homedir.HomeDir(), ".firefly", "control-plane", "pki")
)

const (
	// DefaultFireflySystemNamespace defines the host cluster's namespace used for objects of the controlplane created by fireflyadm.
	DefaultFireflySystemNamespace = "firefly-system"
...
func SetDefaults_InitConfiguration(obj *InitConfiguration) {
	...
	if obj.FireflyNamespace == "" {
		obj.FireflyNamespace = DefaultFireflySystemNamespace
	}
}
